...
export function DueDateChangeModal({ valve, onCancel, onSave, isSaving = false }: DueDateChangeModalProps) {
    ...
    >
      <div className="modal-card due-date-change-modal" role="dialog" aria-labelledby="due-date-change-title">
        <div className="technician-modal-head">
          <h3 id="due-date-change-title">Change due date</h3>
        ...
        <div className="due-date-change-form">
          ...
          <label>
            ...
            <textarea
              ...
              placeholder="Explain why the due date is being moved…"
              disabled={isSaving}
            />
          </label>
        </div>
